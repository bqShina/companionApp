    ...
    var body: some View {
        ...
        VStack(spacing: 50) {
           ...
           Image("angryDog")
               ...
               .confettiCannon(counter: $counter, confettis: [.text("💩")], confettiSize: 20, openingAngle: Angle(degrees: 0), closingAngle: Angle(degrees: 360), radius: 200, repetitions: 6, repetitionInterval: 0.3)
